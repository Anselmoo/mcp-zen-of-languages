        ...
        RuleDetectorBinding(
            ...
            rules=[
                RuleBinding(
                    ...
                    testing_ids=_testing("psscriptanalyzer"),
                    verified_testing_ids=_testing("psscriptanalyzer"),
                    projection_ids=_projection("powershell", "bash", "python"),
                    verified_projection_ids=_projection("powershell"),
                )
            ],
            default_order=50,
        ),
        RuleDetectorBinding(
            ...
            rules=[
                RuleBinding(
                    ...
                    testing_ids=_testing("psscriptanalyzer"),
                    verified_testing_ids=_testing("psscriptanalyzer"),
                    projection_ids=_projection("powershell", "python"),
                    verified_projection_ids=_projection("powershell"),
                )
            ],
            default_order=60,
