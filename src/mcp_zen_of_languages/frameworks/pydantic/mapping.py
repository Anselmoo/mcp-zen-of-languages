...
DETECTOR_MAP = LanguageDetectorMap(
    ...
    bindings=[
        DetectorBinding(
            ...
            universal_dogma_ids=list(framework_rule_dogmas("pydantic-003")),
            default_order=10,
        ),
        DetectorBinding(
            ...
            universal_dogma_ids=list(framework_rule_dogmas("pydantic-005")),
            default_order=20,
        ),
        DetectorBinding(
            ...
            universal_dogma_ids=list(framework_rule_dogmas("pydantic-008")),
            default_order=30,
        ),
        DetectorBinding(
            ...
            universal_dogma_ids=list(framework_rule_dogmas("pydantic-004")),
            default_order=40,
        ),
        DetectorBinding(
            ...
            universal_dogma_ids=list(framework_rule_dogmas("pydantic-001")),
            default_order=50,
        ),
        DetectorBinding(
            ...
            universal_dogma_ids=list(framework_rule_dogmas("pydantic-006")),
            default_order=60,
        ),
        DetectorBinding(
            ...
            universal_dogma_ids=list(framework_rule_dogmas("pydantic-002")),
            default_order=70,
        ),
        DetectorBinding(
            ...
            universal_dogma_ids=list(framework_rule_dogmas("pydantic-007")),
            default_order=80,
        ),
    ],
)
