...
DETECTOR_MAP = LanguageDetectorMap(
    ...
    bindings=[
        RuleDetectorBinding(
            ...
            rules=[RuleBinding(rule_id="bash-001", dogma_ids=_dogmas("ZEN-FAIL-FAST"))],
            default_order=10,
        ),
        RuleDetectorBinding(
        ...
        RuleDetectorBinding(
            ...
            rules=[RuleBinding(rule_id="bash-005", dogma_ids=_dogmas("ZEN-FAIL-FAST"))],
            default_order=25,
        ),
        RuleDetectorBinding(
        ...
        RuleDetectorBinding(
            ...
            rules=[RuleBinding(rule_id="bash-010", dogma_ids=_dogmas("ZEN-FAIL-FAST"))],
            default_order=70,
        ),
        RuleDetectorBinding(
        ...
        RuleDetectorBinding(
            ...
            rules=[RuleBinding(rule_id="bash-012", dogma_ids=_dogmas("ZEN-FAIL-FAST"))],
            default_order=90,
        ),
        RuleDetectorBinding(
