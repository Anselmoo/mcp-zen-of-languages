...
def _slugify_violation(value: str) -> str:
    ...
    Returns:
        str: Lowercase hyphen-separated slug suitable for use as a ``ViolationSpec.id``.
    """
...
class ZenPrinciple(BaseModel):
    ...
    def _normalize_violations(cls, value: object) -> list[ViolationSpec]:
        ...
        Returns:
            list[ViolationSpec]: Normalised list of ``ViolationSpec`` models with unique IDs.
        """
        if value is None:
            return []
...
class LanguageZenPrinciples(BaseModel):
    ...
    def principle_count(self) -> int:
        ...
        Returns:
            int: Length of the ``principles`` list.
        """
...
class AnalysisResult(BaseModel):
    ...
    def violation_count(self) -> int:
        ...
        Returns:
            int: Length of the ``violations`` list.
        """
