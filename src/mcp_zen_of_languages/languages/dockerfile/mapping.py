...
DETECTOR_MAP = LanguageDetectorMap(
    ...
    bindings=[
        ...
        RuleDetectorBinding(
            ...
            rules=[
                RuleBinding(
                    rule_id="dockerfile-003", dogma_ids=_dogmas("ZEN-EXPLICIT-INTENT")
                )
            ],
            default_order=30,
        ),
        ...
        RuleDetectorBinding(
            ...
            rules=[
                RuleBinding(
                    rule_id="dockerfile-008", dogma_ids=_dogmas("ZEN-EXPLICIT-INTENT")
                )
            ],
            default_order=80,
        ),
