...
|----------|:----------:|:---------:|--------|-------------------|
| [Python](python.md) | 22 | 32 | AST | [PEP 20 - The Zen of Python](https://peps.python.org/pep-0020/) |
...
| [SQLAlchemy](../frameworks/sqlalchemy.md) | 6 | 6 | Regex | [SQLAlchemy 2.0 documentation](https://docs.sqlalchemy.org/en/20/) |
| [TypeScript](typescript.md) | 18 | 25 | Regex | [Google TypeScript Style Guide](https://google.github.io/styleguide/tsguide.html) |
| [React](../frameworks/react.md) | 5 | 5 | Regex | [React documentation and Rules of React](https://react.dev/) |
| [Angular](../frameworks/angular.md) | 5 | 5 | Regex | [Angular Style Guide](https://angular.dev/style-guide) |
| [Next.js](../frameworks/nextjs.md) | 5 | 5 | Regex | [Next.js documentation](https://nextjs.org/docs) |
...
| [Vue](../frameworks/vue.md) | 5 | 5 | Regex | [Vue Style Guide](https://vuejs.org/style-guide/) |
...
| **Programming & markup subtotal** | **279** | **298** | | |
...
- **Principles (all categories):** 350
- **Detectors + workflow checks:** 369
